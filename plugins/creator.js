...
let handler = async(m, { conn }) => {
	...
	conn.p[id] = [
	await conn.sendKontak(m.chat, kontak, fkontak, { contexInfo: { forwardingScore: 99999, isForwarded: true } })
	]
	await delay(100)
  return conn.sendMessage(m.chat, { text: `Hai Tod @${await m.sender.split('@')[0]}, Tu Nomor Own Gw`, mentions: [m.sender] }, { quoted: conn.p[id][0] })
  await delay(100)
